...
CListPage::CListPage(CWnd* pParent /*=NULL*/) : CNormalDlg(IDD_LIST_PAGE, pParent),
	IDD(IDD_LIST_PAGE)
{
	m_staticColor = RGB(255, 0, 0);
}

CListPage::CListPage(UINT nIDTemplate, CWnd* pParentWnd) : CNormalDlg(nIDTemplate, pParentWnd),
	IDD(nIDTemplate)
{
	m_staticColor = RGB(255, 0, 0);
}
