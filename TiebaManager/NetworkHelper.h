...
HTTPRequestResult HTTPGetRaw(LPCTSTR URL, unique_ptr<BYTE[]>* buffer = NULL, ULONG* size = NULL, BOOL useCookie = TRUE, volatile BOOL* stopFlag = NULL, CString* cookie = NULL);
